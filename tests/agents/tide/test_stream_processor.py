...
from codetide.agents.tide.ui.stream_processor import ExtractedFields, MarkerConfig, FieldExtractor, StreamProcessor
...
"""
    ...
    # Extract fields
    extracted = extractor.extract(test_content)
